...
class CORSComponent(object):
    def process_response(self, req, resp, resource, req_succeeded):
        ...
        if req_succeeded and req.metod == 'OPTIONS' and req.get_header('Access-Control-Request-Method'):
            allow = resp.get_header('Allow')
            resp.delete_header('Allow')

            allow_headers = req.get_header('Access-Control-Request-Headers', defualt='*')
